...
namespace TwitterText {
    public class Regex {
        ...
        static string ALNUM_CHARS = "a-zA-Z0-9";
        static string ALNUM = "[" + ALNUM_CHARS + "]"; // \p{Alnum}
        static string NOT_ALNUM = "[^" + ALNUM_CHARS + "]"; // \P{Alnum}

        static string PUNCT_CHARS = "\\p{P}\\p{S}";
        static string PUNCT = "[" + PUNCT_CHARS + "]"; // \p{Punct}

        private static string LATIN_ACCENTS_CHARS = "\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u00ff" + // Latin-1
        ...
        private static readonly string HASHTAG_ALPHA_NUMERIC_CHARS = "0-9\uff10-\uff19_" + HASHTAG_ALPHA_CHARS;
        ...
        private static readonly string URL_VALID_PRECEEDING_CHARS = "(?:[^A-Z0-9@＠$#＃\u202A-\u202E]|^)";

        //private static readonly string URL_VALID_CHARS = "[\\p{Alnum}" + LATIN_ACCENTS_CHARS + "]";
        private static readonly string URL_VALID_CHARS = "[" + ALNUM_CHARS + LATIN_ACCENTS_CHARS + "]";
        ...
        //private static readonly string URL_VALID_UNICODE_CHARS = "[.[^\\p{Punct}\\s\\p{Z}\\p{IsGeneralPunctuation}]]";
        ...
        private static readonly string URL_VALID_GTLD =
            ...
            "(?:(?:aero|asia|biz|cat|com|coop|edu|gov|info|int|jobs|mil|mobi|museum|name|net|org|pro|tel|travel|xxx)(?=" + NOT_ALNUM + "|$))";
        ...
        private static readonly string URL_VALID_PORT_NUMBER = "[0-9]+"; // .NET does not support possessive quantifiers
        ...
        **/
        ...
        public static string AT_SIGNS_CHARS = "@\uFF20";
